...
class CustomEffects {
    ...
    getEffects(type) {
        ...
        for (var key in Settings.customEffects) {

            if (Settings.customEffects.hasOwnProperty(key) && Settings.customEffects[key].showOn === type) {

                effect = Util.clone(Settings.customEffects[key]);
